 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme Skeleton
...
add_action( 'tgmpa_register', 'skeleton_register_required_plugins' );
 ...
 */
function skeleton_register_required_plugins() {
	/*
	...
	$plugins = array(
		...
		array(
			...
			'source'             => get_template_directory() . '/tgm/plugins/advanced-custom-fields.5.12.2.zip', // The plugin source.
			'required'           => true, // If false, the plugin is only 'recommended' instead of required.
			'version'            => '5.12.2', // E.g. 1.0.0. If set, the active plugin must be this version or higher. If the plugin version is higher, the user will be notified to update the plugin.
			'force_activation'   => true, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
			'force_deactivation' => true, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins.
			'external_url'       => '', // If set, overrides default API URL and points to an external URL.
			'is_callable'        => '', // If set, this callable will be be checked for availability to determine if a plugin is active.
	 ...
	 */
	$config = array(
		'id'           => 'skeleton',                 // Unique ID for hashing notices for multiple instances of TGMPA.
		...
		/*
		'strings'      => array(
			'page_title'                      => __( 'Install Required Plugins', 'skeleton' ),
			'menu_title'                      => __( 'Install Plugins', 'skeleton' ),
			/* translators: %s: plugin name. * /
			'installing'                      => __( 'Installing Plugin: %s', 'skeleton' ),
			/* translators: %s: plugin name. * /
			'updating'                        => __( 'Updating Plugin: %s', 'skeleton' ),
			'oops'                            => __( 'Something went wrong with the plugin API.', 'skeleton' ),
			...
			'return'                          => __( 'Return to Required Plugins Installer', 'skeleton' ),
			'plugin_activated'                => __( 'Plugin activated successfully.', 'skeleton' ),
			'activated_successfully'          => __( 'The following plugin was activated successfully:', 'skeleton' ),
			/* translators: 1: plugin name. * /
			'plugin_already_active'           => __( 'No action taken. Plugin %1$s was already active.', 'skeleton' ),
			/* translators: 1: plugin name. * /
			'plugin_needs_higher_version'     => __( 'Plugin not activated. A higher version of %s is needed for this theme. Please update the plugin.', 'skeleton' ),
			/* translators: 1: dashboard link. * /
			'complete'                        => __( 'All plugins installed and activated successfully. %1$s', 'skeleton' ),
			'dismiss'                         => __( 'Dismiss this notice', 'skeleton' ),
			'notice_cannot_install_activate'  => __( 'There are one or more required or recommended plugins to install, update or activate.', 'skeleton' ),
			'contact_admin'                   => __( 'Please contact the administrator of this site for help.', 'skeleton' ),
